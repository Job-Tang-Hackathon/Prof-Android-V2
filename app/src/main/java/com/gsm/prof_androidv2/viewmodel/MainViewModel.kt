...
class MainViewModel @Inject constructor(
    ...
    private val _getPostResponse: MutableLiveData<Task<QuerySnapshot>> =
        MutableLiveData<Task<QuerySnapshot>>()
    ...
    val setPhoto: LiveData<QuerySnapshot> get() = _getMyPostResponse
    private val _setPhoto = MutableLiveData<QuerySnapshot>()


    //검색한 게시물 저장
    val getSearchedPostResponse: LiveData<Task<QuerySnapshot>> get() = _getSearchedPostResponse
    private val _getSearchedPostResponse: MutableLiveData<Task<QuerySnapshot>> =
        MutableLiveData<Task<QuerySnapshot>>()
    ...
    fun photoUpload(status: String, imageUrl: ArrayList<String>) =
        repository.photoUpload(status, imageUrl)
    ...
    fun setPhoto(photo:QuerySnapshot){
        _setPhoto.value=photo
    }
